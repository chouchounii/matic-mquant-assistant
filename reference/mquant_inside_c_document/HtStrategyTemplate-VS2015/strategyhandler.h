...
private:
    ...
    std::list<std::string> m_thread1Symbols;
    std::list<std::string> m_thread2Symbols;
    std::list<std::string> m_thread3Symbols;
    std::list<std::string> m_thread4Symbols;
    std::list<std::string> m_thread5Symbols;
